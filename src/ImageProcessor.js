    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
            <div>
                ...
                <input type="number" id="octaves" value={octaves} onChange={e => setOctaves(e.target.value)}  step={1} />
            </div>
            <div>
                <label htmlFor="frequency">Frequency:</label>
                <input type="number" id="frequency" value={frequency} onChange={e => setFrequency(e.target.value)}  step={0.001} />
            </div>
            <div>
                <label htmlFor="amplitude">Amplitude:</label>
                <input type="number" id="amplitude" value={amplitude} onChange={e => setAmplitude(e.target.value)}  step={0.1} />
            </div>
            <div>
                <label htmlFor="persistence">Persistence:</label>
                <input type="number" id="persistence" value={persistence} onChange={e => setPersistence(e.target.value)} step={0.1} />
            </div>
            <div>
                <label htmlFor="scale">Scale:</label>
                <input type="number" id="scale" value={scale} onChange={e => setScale(e.target.value)}  step={5} />
            </div>
